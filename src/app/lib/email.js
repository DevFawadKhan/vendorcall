    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hello ${name},</h2>
            <p>Thank you for registering with VenCall! Please use the OTP below to verify your email address:</p>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="otp-box">${otp}</div>
            <p>Enter this 6-digit code in the password reset page along with your new password.</p>
            <p><strong>This OTP will expire in 15 minutes.</strong></p>
            <p>If you didn't request a password reset, please ignore this email and your password will remain unchanged.</p>
            <p><strong>Security Tip:</strong> Never share your password or this OTP with anyone.</p>
          </div>
          <div class="footer">
            <p>© ${new Date().getFullYear()} VenCall. All rights reserved.</p>
            <p>This is an automated message, please do not reply.</p>
...
export async function sendVerificationEmail(email, name, otp) {
  const mailOptions = {
    from: `"VenCall" <${process.env.EMAIL_FROM}>`,
    to: email,
    subject: "Verify Your Email - VenCall",
    html: emailTemplates.verifyEmail(name, otp),
...
export async function sendPasswordResetEmail(email, name, otp) {
  const mailOptions = {
    from: `"VenCall Support" <${process.env.EMAIL_FROM}>`,
    to: email,
    subject: "Reset Your Password - VenCall",
